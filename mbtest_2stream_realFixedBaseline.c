...
#define  dma_buffer_size        40000000
  ...
  */
  ...
  case 5:
    ...
    char oname_trig[100];
    sprintf(oname_snova, "20160711xxxfixedBaselineFromFile_signal3V_test_snova_%d_%d_%d_%d_%d.dat",amp_thresh,base_mean,base_var,presamples,postsamples);
    sprintf(oname_trig, "20160711xxxfixedBaselineFromFile_signal3V_test_trig_%d_%d_%d_%d_%d.dat",amp_thresh,base_mean,base_var,presamples,postsamples);
	...
	inpf = fopen("/home/ub/module1x_140820_deb_fixbase_6_9_2016.rbf", "r"); // FPGA code with fixed baseline (Jun 9, 2016)
      	printf("\n\t==> Start booting FEM %d\n", imod);
...
'	
	...
	// fix baseline
	FILE* baselinefile = fopen("../channelBaselines.txt","r"); // Baselines for FEM 64 channels at Nevis
...
#if 0
	//Everything ignored until endif
'	
	//vic
	//end copy
	//      imod=11;
