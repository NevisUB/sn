...
//
       ...
       /* sprintf(title1,"vics_data_%d_max_%d.txt",min__,max__); */
...
//      scanf("%d",&ik);
      ...
      printf(" finish XMIT alignment \n");
       ...
       usleep(5000); //wait for 5 ms      /* scanf("%d",&ik); */
...
//
	...
	//DMA is complete !!!!
        ...
        if(idone == 0) { printf("\t==> DMA fucked up...\n"); break; }
	...
	/* } */
       ...
       printf("\nSpeed: at doing DMA %.6f MB/Sec", (float) ndma_loop * ( (float)dwDMABufSize / ( 10000000.0 ) ) / ( mytime  / 1000000.0 ) );

       
       

       sprintf(title,"vicsdata_min_%d_max_%d.dat",min__,max__);
       fd_sn = creat(title,0755);
       printf("fd_sn = %d\n", fd_sn);
       nwrite_2 = write(fd_sn,read_array,dwDMABufSize*ndma_loop);
       ...
       /* mytime = seconds*1000000. + useconds*1.; //elapsed time in usec */
       /* printf("\nElapsed time:\t\t\t %ld usec\n\n", mytime); */
       /* printf("\nSpeed: at filling read_array %.6f MB/Sec", ( (float)dwDMABufSize / ( 1000000.0 ) ) / ( mytime  / 1000000.0 ) ); */
