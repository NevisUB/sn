...
//
	...
	int n_write2;
	fd_sn = creat("joses_data_01142016_1124.dat",0755);
	printf("fd_sn = %d\n", fd_sn);
	n_write2 = write(fd_sn,read_array,sizeof(read_array)/sizeof(read_array[0]));
	printf("\t==> Done writing the file: n_write2: %d !!!!!\n",nwrite);
